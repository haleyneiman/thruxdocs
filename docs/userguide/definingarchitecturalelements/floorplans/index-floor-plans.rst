...
The best application of the floor plans is always to import an architectural REVIT model (how to :ref:`here <>`), but follow the steps below to model the geometry manually if a model doesn't exist. 
